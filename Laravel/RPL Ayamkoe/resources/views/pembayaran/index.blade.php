                            ...
                            <tbody>
                                @foreach ($pembayaran as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->status }}</td>
                                        <td>
                                            <a href="{{ route('pesanan.showNonEditable', $item) }}" class="btn btn-warning">Detil</a>
                                            <a href="{{ route('pembayaran.edit', $item) }}" class="btn btn-warning">Status</a>
                                        </td>
                                        @if($item->status == 'Pending')
                                            <td>
                                                <a href="{{ route('pesanan.showEditKaryawan', $item) }}" class="btn btn-warning">Edit</a>
                                            </td>
                                            <td>
